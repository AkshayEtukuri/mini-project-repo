...
main = Tk()
main.title("Respiratory analysis detection of various lung infections using caugh signal")
...
font = ('times', 15, 'bold')
title = Label(main, text='Respiratory analysis detection of various lung infections using caugh signal')
